...
class CustomVoxelPhantom:
    ...
    def __init__(self,
                 ...
                 PD: float | torch.Tensor = 1.0,
                 T1: float | torch.Tensor = 1.5,
                 T2: float | torch.Tensor = 0.1,
                 T2dash: float | torch.Tensor = 0.05,
                 D: float | torch.Tensor = 1,
                 B0: float | torch.Tensor = 0,
                 B1: float | torch.Tensor = 1,
