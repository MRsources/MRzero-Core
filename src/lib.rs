...
mod pre_pass;
use pre_pass::{comp_graph, comp_graph_ss, Repetition};
...
/// compute_graph_ss(seq, start_mag, t1, t2, t2dash, max_dist_count, min_dist_mag, nyquist, size, normalized_grads)
/// --
///
/// Computes a graph for the given sequence and parameters.
/// !!! Tensors are assumed to be 32 bit floats!
...
fn _prepass(_py: Python, m: &PyModule) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(compute_graph_ss, m)?)?;
